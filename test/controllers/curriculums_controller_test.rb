...
class CurriculumsControllerTest < ActionController::TestCase
  ...
  test "should create curriculum" do
    assert_difference('Curriculum.count') do
      post :create, curriculum: { description: @curriculum.description, level: @curriculum.level, title: @curriculum.title, topic_id: @curriculum.topic_id, user_id: @curriculum.user_id }
    end
  ...
  test "should update curriculum" do
    patch :update, id: @curriculum, curriculum: { description: @curriculum.description, level: @curriculum.level, title: @curriculum.title, topic_id: @curriculum.topic_id, user_id: @curriculum.user_id }
    assert_redirected_to curriculum_path(assigns(:curriculum))
  end
